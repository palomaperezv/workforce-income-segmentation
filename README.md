...
|--------|-------|
| Test Accuracy | 82% |
| Recall (high-income class) | 85% |
| F1-Score (high-income class) | 0.69 |
| Efficiency vs. random baseline | **2.4x** |
...
<img width="589" height="455" alt="class_distribution" src="https://github.com/user-attachments/assets/de13e815-c78a-44e9-9a79-131ae377b0db" />

> 75.7% of records fall below $50K — class imbalance handled via balanced weights in the classifier.

### 2. Feature Importance
<img width="815" height="455" alt="feature_imoprtances" src="https://github.com/user-attachments/assets/d726b1d1-c7d7-4844-9e00-9d68c26a73bb" />
...
### 3. Confusion Matrix
<img width="548" height="455" alt="confusion_matrix" src="https://github.com/user-attachments/assets/75b2323c-3b15-4ed4-a40d-b43c3ea89f81" />
...
```bash
git clone https://github.com/palomaperezv/income-prediction-model.git
...
[GitHub](https://github.com/palomaperezv) · [LinkedIn](https://www.linkedin.com/in/paloma-perez-valdenegro-27a2621a5/) · palomprz@gmail.com
